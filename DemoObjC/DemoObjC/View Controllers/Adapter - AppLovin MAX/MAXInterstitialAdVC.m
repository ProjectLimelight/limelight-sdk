...
@property (nonatomic, strong, nullable) MAInterstitialAd *maInterstitialAd;

@end

// MARK: - Implementation

@implementation MAXInterstitialAdVC
...
- (void)setupAndLoadAd {
    ...
    MAInterstitialAd *maInterstitialAd = [[MAInterstitialAd alloc] initWithAdUnitIdentifier:self.adConfigId];
    maInterstitialAd.delegate = self;
    [maInterstitialAd loadAd];
    self.maInterstitialAd = maInterstitialAd;
}

- (void)showAd {
    if (self.maInterstitialAd.isReady && !self.maInterstitialAd.isShowing) {
